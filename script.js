...
document.addEventListener('DOMContentLoaded', () => {
    ...
    [
        ...
        },
        {
            ...
            "comments": [
                { "id": "comment-5", "user": "William H.", "text": "The archaeological findings from the Towton mass graves are chilling. A truly brutal affair." }
            ]
        },
        {
            "id": "post-004",
            ...
            "comments": [
                { "id": "comment-6", "user": "Lancaster_Loyalist", "text": "A true queen who fought for her son's birthright against traitors and usurpers." },
                { "id": "comment-7", "user": "Gregory M.", "text": "Her refusal to compromise probably prolonged the war by years." }
            ]
        },
        {
            "id": "post-005",
            ...
            "comments": [
                { "id": "comment-8", "user": "RicardianSociety", "text": "Loyalty until death! The Tudor smear campaign must be exposed." },
                { "id": "comment-9", "user": "Henry_T", "text": "He usurped the throne from a child. His motivations are clear, regardless of propaganda." }
            ]
        },
        {
            "id": "post-006",
            ...
            "comments": [
                { "id": "comment-10", "user": "WelshDragon", "text": "A great day for Wales and for England!" },
                { "id": "comment-11", "user": "John de Vere", "text": "The Stanleys were opportunists, plain and simple. Their betrayal, not Tudor's skill, won the day." }
            ]
        },
        {
            "id": "post-007",
            ...
            "comments": [
                { "id": "comment-12", "user": "Investigator_G", "text": "It has to be Richard. Occam's razor." },
                { "id": "comment-13", "user": "The_Contrarian", "text": "What if they survived? There were pretenders like Lambert Simnel and Perkin Warbeck for a reason." }
            ]
        },
        {
            "id": "post-008",
            ...
            "comments": [
                { "id": "comment-14", "user": "CourtWatcher", "text": "Edward's one major political blunder. It cost him Warwick's support and created a faction that hated his heir." },
                { "id": "comment-15", "user": "Elizabeth W.", "text": "Or perhaps it was a king choosing his own destiny, and the 'old guard' simply couldn't handle it." }
            ]
        },
        {
            "id": "post-009",
            ...
            "comments": [
                { "id": "comment-16", "user": "Heraldry_Geek", "text": "Absolutely correct. The personal badges and banners were far more significant on the battlefield." },
                { "id": "comment-17", "user": "Tudor_Rose_Fan", "text": "Propaganda or not, it's one of the most beautiful and enduring symbols in English history." }
            ]
        },
        {
            "id": "post-010",
            ...
            "comments": [
                { "id": "comment-18", "user": "Richard a G.", "text": "A true warrior king. If he had lived another ten years, the Tudor dynasty would never have happened." },
                { "id": "comment-19", "user": "Isabelle d'Anvers", "text": "His love of luxury and women was his undoing. It sowed the seeds of the conflict that consumed his sons." }
            ]
        }
    ]
    `;
